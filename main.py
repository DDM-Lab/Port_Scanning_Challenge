    ...
    def connect_to_port(self, port_str):
        ...
        if port in self.open_ports:
            ...
            if port in self.flag_parts:
                ...
                if part_number != 4:
                    print(f"[+] You need to connect to another port for the next part.")
